...
/// </summary>
public class JaccardMatrixSimilarity : AbstractLocalSimilarity
{
    /// <summary>
    /// Construtor da classe MatrixSimilarity.
    /// </summary>
    public JaccardMatrixSimilarity()
	{
	...
	public override float GetSimilarity(ConsultParams consultParams, Case searchCase, Case retrieveCase)
	{
        ...
        var vecA = new double[vectorA.Count];
        var vecB = new double[vectorB.Count];
        ...
        JaccardDistance sim = new JaccardDistance();
        float similarityScore = (float)sim.GetDistance(vecA, vecB);
