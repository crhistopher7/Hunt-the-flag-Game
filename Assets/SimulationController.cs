...
public class SimulationController : MonoBehaviour
{
    ...
    public Material realFlag;
    public Boolean showGoalsNature;
    ...
    public void SetShowGoalsNature(Boolean value)
    {
        this.showGoalsNature = value;
        if (showGoalsNature)
        {
            pcTeam2.deceptiveTransform.GetComponent<MeshRenderer>().material = realFlag;
        }
        else
        {
