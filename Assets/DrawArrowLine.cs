...
public class DrawArrowLine : MonoBehaviour
{
    ...
    {
        LineRenderer.SetPosition(0, new Vector3(position.x, position.y, Constants.AGENT_POSITION_Z));
        LineRenderer.SetPosition(1, new Vector3(mousePosition.x, mousePosition.y,Constants.AGENT_POSITION_Z));
    }
}
